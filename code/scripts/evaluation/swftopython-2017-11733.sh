#rm -rf swftopython-CVE-2017-11733
git clone https://github.com/libming/libming.git swftopython-CVE-2017-11733
cd swftopython-CVE-2017-11733/; git checkout b72cc2f # version 0.4.8
rm -rf obj-aflgo
...
echo ' ' >in/tmp.swf
$AFLGO/afl-fuzz -x /transferfuzz/scripts/fuzz_dict/cve-2017-11733.txt -R out/fuzz_record.txt -F $TMP_DIR/target_map.txt -m none -z exp -c 45m -i in -o out -d ./util/swftopython @@
