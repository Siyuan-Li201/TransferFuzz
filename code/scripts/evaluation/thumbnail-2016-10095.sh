...
$AFLGO/afl-fuzz -x /transferfuzz/scripts/fuzz_dict/cve-2016-10095.txt -R out/fuzz_record.txt -F $TMP_DIR/target_map.txt -m none -c 45m -i in -o out -d -- tools/thumbnail @@ out.tif
