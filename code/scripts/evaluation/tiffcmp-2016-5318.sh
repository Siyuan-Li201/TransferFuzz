...
cd tools; 
$AFLGO/scripts/genDistance.sh $SUBJECT $TMP_DIR tiffcmp
cd ../../; 
rm -rf obj-dist;
mkdir obj-dist; 
...
$AFLGO/afl-fuzz -x /transferfuzz/scripts/fuzz_dict/cve-2016-5318.txt -R out/fuzz_record.txt -F $TMP_DIR/target_map.txt -m none -c 45m -i in -o out -d -- tools/tiffcmp @@ @@
