#rm -rf swftotcl-CVE-2018-8807
git clone https://github.com/libming/libming.git swftotcl-CVE-2018-8807
cd swftotcl-CVE-2018-8807/; git checkout b72cc2f # version 0.4.8
rm -rf obj-aflgo
