#rm -rf swftopython-CVE-2018-8962
git clone https://github.com/libming/libming.git swftopython-CVE-2018-8962
cd swftopython-CVE-2018-8962/; git checkout b72cc2f # version 0.4.8
rm -rf obj-aflgo
