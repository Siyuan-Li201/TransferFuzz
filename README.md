...
Put the basic binary and poc into the directory `/data/bin/` and `/data/poc/` (The basic binary *tiffsplit* can be found at */bin* of github and poc can be found at */poc* or generated by Directed Fuzzing)
...
Put the basic binary and poc into the directory `./bin/` and `./poc/` (The basic binary *tiffsplit* can be found at */bin* of github and poc can be found at */poc* or generated by Directed Fuzzing)
